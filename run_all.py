...
# heights of bars 
    height = [float(dt_value),float(kn_value),float(nb_value),float(100*rf_value),float(svm_1),float(svm_2)] 
  
# labels for bars 
    tick_label = ['DT', 'KNN', 'NB', 'RF','SVM_L','SVM_R'] 
  
# plotting a bar chart 
    plt.bar(left, height, tick_label = tick_label, 
        width = 0.8, color = ['red', 'yellow', 'blue','black','pink','green']) 
